...
public class ConstantesBaseDatos {
    ...
    public static final String TABLE_MASCOTA_GRID = "mascota_grid";
    public static final String TABLE_MASCOTAS_GRID_ID = "id_grid";
    public static final String TABLE_MASCOTAS_GRID_FOTO = "foto_grid";
    public static final String TABLE_MASCOTA_GRID_NUMERO_LIKES = "numero_likes_grid";
}
